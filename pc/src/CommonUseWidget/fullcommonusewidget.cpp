...
//    mainLayout->setContentsMargins(Style::LeftWidWidth,0,0,0);
    mainLayout->setContentsMargins(Style::listleftMargin,0,Style::listleftMargin+6,0);//Style::listleftMargin,100
    this->setLayout(mainLayout);
    m_spaceItem=new QSpacerItem(0,20,QSizePolicy::Expanding,QSizePolicy::Fixed);// 40-50
...
void FullCommonUseWidget::initAppListWidget()
{
    ...
    m_listView->setFixedSize(this->width()-Style::listleftMargin*2+6,this->height());//Style::widthavailable-Style::LeftWidWidth
