...
//    this->setFixedSize(w,h);
    ...
    this->verticalScrollBar()->setStyleSheet("QScrollBar{padding-top:500px;padding-bottom:500px;background:transparent;width:10px;border-radius:1.5px;;height:200px;}"
                                             "QScrollBar::handle{background-color:rgba(255,255,255,0.25); width:6px;border-radius:1.5px;height:20px;}"
                                             "QScrollBar::handle:hover{background-color:#697883;width:3px;border-radius:1.5px; width:6px;height:20px;}"
                                             "QScrollBar::handle:pressed{background-color:#8897a3;width:3px;border-radius:1.5px; width:6px;height:20px;}"
