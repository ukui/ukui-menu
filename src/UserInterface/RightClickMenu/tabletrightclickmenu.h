...
class TabletRightClickMenu : public QWidget
{
    Q_OBJECT
public:
    /**
     ...
     *  2: others
     */
    explicit TabletRightClickMenu(QWidget *parent = nullptr);
    virtual ~TabletRightClickMenu();
    /**
