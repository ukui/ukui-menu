...
TabletWidget::TabletWidget(QWidget *parent, int w, int h) : QWidget(parent)
{
...
QVector<QString> TabletWidget::keyVector=QVector<QString>();
QVector<int> TabletWidget::keyValueVector=QVector<int>();

void TabletWidget::initUi()
{
...
//    this->addTab(page1, QString());
//    page2 = new QWidget(this);
//    this->addTab(page2, QString());
...
void TabletWidget::initAppListWidget()
{
    m_listView=new TabletListView(this,0);
...
void TabletWidget::setStyleTable(int appnum)
{
...
void TabletWidget::fillAppList()
{
    ...
    connect(m_listView,&TabletListView::sendHideMainWindowSignal,this,&TabletWidget::sendHideMainWindowSignal);
    connect(m_listView,&TabletListView::sendItemClickedSignal,this,&TabletWidget::execApplication);
    connect(m_listView,&TabletListView::pagenumchanged,this,&TabletWidget::pagenumchanged);
    connect(m_listView,&TabletListView::sendUpdateAppListSignal,this,&TabletWidget::updateListViewSlot);
    connect(m_listView,&TabletListView::sendPageLeft,this,&TabletWidget::sendPageLeft);
    connect(m_listView,&TabletListView::sendPageRight,this,&TabletWidget::sendPageRight);
...
bool TabletWidget::cmpApp(QString &arg_1, QString &arg_2)
{
...
//执行应用程序
void TabletWidget::execApplication(QString desktopfp)
{
    QString str;
    //打开文件.desktop
...
void TabletWidget::updateListViewSlot()
{
...
void TabletWidget::deleteAppListView()
{
    m_data.clear();
    keyVector.clear();
    keyValueVector.clear();
...
void TabletWidget::repaintWid(int type)
{
    if (!m_listView) {
        m_listView = new TabletListView(this, 0);
    }
